...
SaleTransaction = "CREATE TABLE sale_transaction(SALE_ID VARCHAR(10) PRIMARY KEY NOT NULL ,SALE_DATE DATE NOT NULL, AMOUNT int(3) NOT NULL);"
...
Distributor = "CREATE TABLE supplier(SUPPLIER_ID VARCHAR(10) PRIMARY KEY NOT NULL, SUPPLIER_NAME VARCHAR(20) NOT NULL, REFERENCED_BY VARCHAR(20), CONTACT_NO INT(10) UNSIGNED, JOIN_DATE DATE NOT NULL);"
