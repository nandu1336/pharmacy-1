...
Purchase = "CREATE TABLE purchase(PRODUCT_NAME TEXT NOT NULL, GENERIC_NAME TEXT NOT NULL,\
 MRP FLOAT(7,2) UNSIGNED NOT NULL, QUANTITY INT(2) NOT NULL, AMOUNT FLOAT(7,2) UNSIGNED NOT NULL);"
...
Distributor = "CREATE TABLE supplier(SUPPLIER_ID VARCHAR(10) PRIMARY KEY NOT NULL, COMPANY_NAME VARCHAR(20) UNIQUE NOT NULL, REFERENCED_BY VARCHAR(20), CONTACT_NO VARCHAR(10) , JOIN_DATE DATE NOT NULL);"
